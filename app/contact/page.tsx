    ...
    <div className="w-full h-[90vh] flex flex-col md:flex-row justify-center items-center gap-x-3 gap-y-10 p-10">
      <div className="max-w-[25rem] flex flex-col gap-y-4">
        ...
        <p className="text-md md:text-xl">
          Feel free tofill out the form to send me an email! I&apos;m excited to
          get in touch!
        </p>
      </div>
      {isLoading ? (
        ...
        <form
          ...
          className="w-[20rem] md:w-[30rem] flex flex-col gap-y-4"
        >
          <OutlineTextInput
            type="text"
            label="Name"
          ...
          <div className="flex flex-row justify-end md:flex-row gap-5">
            <Button style="outlined" type="button" onClick={() => reset()}>
              Clear
            </Button>
